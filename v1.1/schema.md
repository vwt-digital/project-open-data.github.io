...
* Catalog
    ...
    * {: .field-required}[dataset](#dataset)
        ...
        * {: .field-required}[qualifiedRelation](#qualifiedRelation)
            * {: .field-optional}[relation](#qualifiedRelation-relation)
        ...
        * {: .field-required-if-applicable}[distribution](#distribution)
            ...
            * {: .field-required}[qualifiedRelation](#distribution-qualifiedRelation)
                * {: .field-optional}[relation](#distribution-qualifiedRelation-relation)
...
{: .table .table-striped #publishDataCatalog}
**Field [#](#publishDataCatalog){: .permalink}** | **publishDataCatalog**
----- | -----
**Cardinality** | (1,2)
**Required** | Yes, always
**Accepted Values** | String (URI)
